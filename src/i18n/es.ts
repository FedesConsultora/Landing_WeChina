const es = {
  // ── Meta ──
  meta: {
    description: 'Expertos en logística y comercio exterior con China. Más de 20 años eliminando los riesgos de tu inversión en Asia.',
  },
  ...
  // ── Hero ──
  hero: {
    title: 'Eliminá el miedo a importar,',
    highlight: 'con nosotros tu carga no queda varada',
    subtitle: 'Expertos allá, socios acá. 20 años eliminando los riesgos de tu inversión en Asia.',
    stats: [
  ...
  // ── Highlights ──
  highlights: {
    heading: 'EL 90% DE LOS PROBLEMAS DE IMPORTACIÓN OCURREN POR FALTA DE PRESENCIA FÍSICA',
    text: 'Nosotros estamos ahí.',
  },

  // ── Service Grid (Home) ──
  serviceGrid: {
    title: 'PROTEGEMOS TU INVERSIÓN EN CHINA',
    subtitle:
      'Convertimos la incertidumbre de importar en un sistema de pasos controlados. Desde la validación legal de la fábrica hasta la inspección final antes del despacho.',
    cards: [
      {
    ...
    knowMore: 'Conocé más',
    knowMoreSub: 'de nuestros servicios',
  },

  // ── Logistics CTA ──
  logisticsCTA: {
    title: 'Tus expertos en',
    highlight: 'otro continente',
    cta: 'Hablá con un experto',
  },

  // ── Sector Bridge (Home) ──
  sectorBridge: {
    title: 'TU PUENTE DIRECTO A FABRICANTES LÍDERES DE CADA SECTOR',
    desc: 'No somos generalistas. Contamos con equipos especializados en industrias de calzado, textil, papelera y desarrollos industriales estratégicos.',
    sectors: [
      'Maquinarias',
      'Industria de materiales de construcción',
      'Industrias calzado y marroquinería',
      'Industria textil e indumentaria',
    ],
    viewAll: 'Ver todos los rubros',
  },

  // ── About ──
  about: {
    pageTitle: 'WeChina - Nosotros',
    title: 'Comprensión del mercado y audacia en los negocios,',
    titleHighlight: 'somos WeChina.',
    p1: 'El conocimiento y la comprensión de los negocios abren puertas a nuevas oportunidades. Por eso queremos compartir y facilitarles los procesos industriales, logísticos, legales, administrativos y fiscales, basados en nuestra experiencia por más de 15 años a quienes compran, fabrican o realizan negocios internacionales con China.',
    p2: 'Somos el aliado estratégico a nivel comercial y logístico que cualquier emprendedor, empresa o industria debería tener, ofreciendo un servicio profesional y de alta performance en el mercado chino.',
  },

  // ── Services Page ──
  servicesPage: {
    pageTitle: 'WeChina - Servicios',
    mainTitle: 'Tu estructura de comercio exterior',
    mainTitleHighlight: 'en Asia.',
    items: [
      {
        id: 'agentes-de-compras',
        title: 'Agentes de compras',
      ...
      },
      {
        ...
        description: [
          ...
          'Naturaleza de la carga: Tipo de mercadería a transportar.',
          'Ruta operativa: puertos de origen y destino solicitado',
          'Volumen técnico: Dimensiones o pies cúbicos del contenedor.',
        ],
      },
      {
        id: 'validacion-de-fabricantes-online',
  ...
  // ── Rubros Page ──
  rubrosPage: {
    pageTitle: 'WeChina - Rubros',
    titleRed: 'Conocemos la matriz',
    titleRest: 'técnica de tu negocio.',
    desc: 'No somos operadores generalistas. Dominamos la cadena de suministros de industrias específicas, garantizando que el producto que llega a tu depósito sea exactamente el que tu mercado exige.',
    sectors: [
      'Industrias calzado y marroquinería',
      'Industria textil e indumentaria',
      'Industria papelera',
      ...
      'Industria de materiales de construcción',
      'Desarrollos de proyectos industriales',
  ...
  // ── Clients Page ──
  clientsPage: {
    pageTitle: 'WeChina - Clientes',
    headingRed: 'Respaldo real',
    headingRest: 'para proyectos de largo plazo.',
    body: 'No solo gestionamos contenedores; diseñamos sistemas de comercio exterior para empresas que buscan escalabilidad y previsibilidad. La confianza de nuestros clientes se basa en nuestra capacidad de ser su oficina técnica en origen.',
    cta: 'Hablá con un experto',
  },
  ...
  footer: {
    ...
    servicesMore: 'Conocé más',
    serviceLinks: [
      'Agentes de compras',
      'Búsqueda de proveedores',
      'Control de calidad',
      'Fletes marítimos y aéreos',
      'Validación de fabricantes online',
      'Manejo de muestras',
      'Almacenaje y consolidación de cargas',
  ...
  pageTitles: {
    home: 'WeChina - Inicio',
    about: 'WeChina - Nosotros',
    services: 'WeChina - Servicios',
    sectors: 'WeChina - Rubros',
    clients: 'WeChina - Clientes',
  },
};
